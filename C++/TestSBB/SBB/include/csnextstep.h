...
#ifdef SB_USE_CLASS_TPLNEXTSTEP
class TPlNextStep: public TPlASCII
{
	private:
		SB_DISABLE_COPY(TPlNextStep)
	public:
		...
		TPlNextStep(TPlNextStepHandle handle, TElOwnHandle ownHandle);

		TPlNextStep();

		static TPlNextStep CreateForFinalize();
